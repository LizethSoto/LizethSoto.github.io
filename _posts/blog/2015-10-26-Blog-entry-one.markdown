...
<h2 style="font-size: 30px; font-family: Verdana;text-align: center;">Cuando NO intentar reproducir este proyecto:</h2>
<ul>
...
<h2 style="font-size: 30px; font-family: Verdana;text-align: center;">Faster RCNN</h2>
<h2 style="font-size: 30px; font-family: Verdana;text-align: center;">SSD Mobilenet</h2>
<h1 style="font-size: 40px; font-family: Verdana; text-align: center;">Comenzar el entrenamiento</h1>
<h2 style="font-size: 30px; font-family: Verdana;text-align: center;">Conseguir datos</h2>
<div class="textarea">
...
<h2 style="font-size: 30px; font-family: Verdana;text-align: center;">Preparar los datos</h2>
...
<h2 style="font-size: 30px; font-family: Verdana;text-align: center;">Preparar las etiquetas</h2>
...
<h2 style="font-size: 30px; font-family: Verdana;text-align: center;">Crear el archivo CSV</h2>
...
<h2 style="font-size: 30px; font-family: Verdana;text-align: center;">Entrenar</h2>
